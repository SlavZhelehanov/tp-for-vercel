    ...
    return (
        <div className="">
            ...
            {isAuthenticated && <form action={getComment} className="flex items-center gap-4">
                <img src={owner?.avatar || "/no-avatar.png"} alt="Avatar" width={32} height={32} className="w-8 h-8 rounded-full" />
                ...
                <div className="flex-1 flex items-center justify-between bg-slate-100 rounded-xl text-sm px-6 py-2 w-full">
                    ...
                    <img src="emoji.jpg" alt="emoji" width={16} height={16} className="cursor-pointer" />
